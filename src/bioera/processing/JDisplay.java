/* JDisplay.java v 1.0.9   11/6/04 7:15 PM
 *
...
public abstract class JDisplay extends SingleElement implements DependentOnRepaint{
	JChart dChart;
public JDisplay() {
	super();
	getChart();
...
protected abstract JChart createChart();
...
public final JChart newChart() {
	JChart ret = createChart();
	ret.setElement(this);
	ret.setName(getName());
	setChart(ret);
	return ret;
