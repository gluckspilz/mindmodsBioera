/* BetterGridLayout.java v 1.0.9   11/6/04 7:15 PM
 *
...
class BetterGridLayout extends ConstraintLayout {
	...
	public BetterGridLayout(int irows, int icols, int ihGap, int ivGap, int ihMargin, int ivMargin) {
