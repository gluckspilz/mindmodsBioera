/* JGraphPanel.java v 1.0.9   11/6/04 7:15 PM
 *
 ...
 */
public class JGraphPanel extends DBCanvas {
	JFrame frame;
	public JTieSet connections;
	public JBoxSet boxes;
 ...
 */
public JGraphPanel(JFrame f) {
	super();
	frame = f;
	connections = new JTieSet(this);
	boxes = new JBoxSet(this);
}
/**
 * LinesPanel constructor comment.
 */
