/* Chart.java v 1.0.9   11/6/04 7:15 PM
 *
...
public abstract class Chart {
	...
	protected ChartDialog parentDialog;
 ...
 * @param length int
 */
public final static Chart newInstance(String className) throws Exception {
	try {
		Class c = Tools.createClass(className);
		Chart e = (Chart) c.newInstance();
