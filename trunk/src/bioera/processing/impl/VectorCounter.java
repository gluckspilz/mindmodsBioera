/* VectorCounter.java v 1.0.9   11/6/04 7:15 PM
 *
 ...
 */
public final class VectorCounter extends SingleElement {
	...
	protected static boolean debug = bioera.Debugger.get("impl.vector.counter");
/**
