/* NumericDisplay.java v 1.0.9   11/6/04 7:15 PM
 *
 ...
 */
public final class NumericDisplay extends Display {
...
//        if((b[n-1]>1000000) && (b[n-1]<-1000000))chart.pushTextLeft("");
        if (b[n-1]>5000 | b[n-1]<-5000)chart.pushTextLeft(" ");
//        if(b[n-1]>700000)chart.pushTextLeft("");
//        if(b[n-1]<-700000)chart.pushTextLeft("");
//        else{chart.pushTextLeft(Integer.toString(b[n-1] * physRange / digiRange));}
        else{ pushtoChart(b[n-1] * physRange / digiRange); }
