/* DspTargetDataLine.java v 1.0.9   11/6/04 7:15 PM
 *
 ...
 * @author: Jarek
 */
public class DspTargetDataLine implements TargetDataLine {
	bioera.nativeobjects.SoundIOCTL soundDev;
/**
 * DspSourceDataLine constructor comment.
 */
public DspTargetDataLine(bioera.nativeobjects.SoundIOCTL sdev) {
	super();
...
public int getBufferSize() {
	return soundDev.getReadBufferSize();
}
/**
...
public javax.sound.sampled.AudioFormat getFormat() {
	return new AudioFormat(
		soundDev.getReadRate(),
		soundDev.getReadBits(),
		soundDev.getReadChannels(),	// number of channels
		true,	// signed
		false);	// big endian
}
/**
 ...
 * read method comment.
 */
public int read(byte[] arg1, int offs, int count) {
	return soundDev.fa.read(arg1, offs, count);
}
/**
