/* IntegerCompoundScale.java v 1.0.9   11/6/04 7:15 PM
 *
 ...
 */
public class IntegerCompoundScale extends LeftCompoundProperty {
	public int value;
	public Scale scale;
/**
 * IntegerVertScale constructor comment.
 */
public IntegerCompoundScale(int v, Scale s) {
	value = v;
	scale = s;
}
/**
...
public java.awt.Component getC1() throws java.lang.Exception {
	return tf1 = new JTextField("" + value);
}
/**
 * Insert the method's description here.
 * Creation date: (5/28/2004 3:11:50 PM)
